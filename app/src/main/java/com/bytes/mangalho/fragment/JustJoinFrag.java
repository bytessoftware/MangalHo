...
import com.bytes.mangalho.adapter.AdapterJustJoin;
...
public class JustJoinFrag extends Fragment implements SwipeRefreshLayout.OnRefreshListener{
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        dashboard.binding.headerNameTV.setText(getResources().getString(R.string.nav_home));
