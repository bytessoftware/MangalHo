package com.bytes.mangalho.multipleimagepicker;
...
import com.bytes.mangalho.multipleimagepicker.adapters.FolderAdapter;
import com.bytes.mangalho.multipleimagepicker.adapters.ImageGridAdapter;
import com.bytes.mangalho.multipleimagepicker.listeners.FolderOnItemClickListener;
import com.bytes.mangalho.multipleimagepicker.listeners.ImageOnItemClickListener;
import com.bytes.mangalho.multipleimagepicker.models.Folder;
import com.bytes.mangalho.multipleimagepicker.models.Image;
import com.bytes.mangalho.multipleimagepicker.utils.FileUtils;
import com.bytes.mangalho.multipleimagepicker.utils.ScreenUtils;
            ...
            if (intent.resolveActivity(getActivity().getPackageManager()) != null) {
                ...
                if (mTmpFile != null && mTmpFile.exists()) {
                    ...
                    if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.N) {
                        // imgPathUri = FileProvider.getUriForFile(getActivity().getApplicationContext(), "com.samyotech.matrimony", mTmpFile);
