...
public class AdapterSearchMain extends RecyclerView.Adapter<AdapterSearchMain.MatchesHolder> {
    ...
    public void onBindViewHolder(@NonNull final MatchesHolder holder, final int position) {
        ...
        if (userDTOList.get(position).getShortlisted() == 0) {
            holder.binding.ivShortList.setImageDrawable(context.getResources().getDrawable(R.drawable.ic_shortlist));
        } else {
            holder.binding.ivShortList.setImageDrawable(context.getResources().getDrawable(R.drawable.ic_shortlist_done));
        }
        ...
        holder.binding.llShortList.setOnClickListener(new View.OnClickListener() {
            ...
            if (userDTOList.get(position).getRequest() == 1) {
                holder.binding.ivInterest.setImageDrawable(context.getResources().getDrawable(R.drawable.ic_already_sent));
            } else if (userDTOList.get(position).getRequest() == 2) {
                holder.binding.ivInterest.setImageDrawable(context.getResources().getDrawable(R.drawable.ic_send_interest));
            } else {
                holder.binding.ivInterest.setImageDrawable(context.getResources().getDrawable(R.drawable.ic_send_interest));
            }
        ...
        holder.binding.llContact.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (userDTOList.get(position).getMobile2().equalsIgnoreCase("")) {
                    ...
                    spinnerDialog = new SpinnerDialog(context, userDTOList.get(position).getName(), userDTOList.get(position).getUser_avtar(), R.style.DialogAnimations_SmileWindow);
