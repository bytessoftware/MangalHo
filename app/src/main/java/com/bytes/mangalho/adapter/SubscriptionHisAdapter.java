...
import com.bytes.mangalho.Models.SubscriptionHistoryDto;
...
public class SubscriptionHisAdapter extends RecyclerView.Adapter<SubscriptionHisAdapter.MyViewHolder> {
    ...
    public void onBindViewHolder(final MyViewHolder holder, final int position) {
        ...
        holder.tvPrice.setText("₹ " + objects.get(position).getPrice());
        holder.tvSubType.setText(objects.get(position).getSubscription_name());

        holder.tvStartDate.setText(objects.get(position).getSubscription_start_date()+" "+mContext.getResources().getString(R.string.to)+" "+ objects.get(position).getSubscription_end_date());
