...
public class AdapterVisitor extends RecyclerView.Adapter<AdapterVisitor.MatchesHolder> {
    ...
    public void onBindViewHolder(@NonNull final MatchesHolder holder, final int position) {
        ...
        if (joinDTOList.get(position).getShortlisted() == 0) {
            holder.binding.ivShortList.setImageDrawable(visitorsFrag.getResources().getDrawable(R.drawable.ic_shortlist));
        } else {
            holder.binding.ivShortList.setImageDrawable(visitorsFrag.getResources().getDrawable(R.drawable.ic_shortlist_done));
        }
        ...
        if (joinDTOList.get(position).getRequest() == 1) {
            holder.binding.ivInterest.setImageDrawable(visitorsFrag.getResources().getDrawable(R.drawable.ic_already_sent));
        } else if (joinDTOList.get(position).getRequest() == 2) {
            holder.binding.ivInterest.setImageDrawable(visitorsFrag.getResources().getDrawable(R.drawable.ic_send_interest));
        } else {
            holder.binding.ivInterest.setImageDrawable(visitorsFrag.getResources().getDrawable(R.drawable.ic_send_interest));
        }
        ...
        holder.binding.llContact.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (joinDTOList.get(position).getMobile2().equalsIgnoreCase("")) {
                    ...
                    spinnerDialog = new SpinnerDialog(visitorsFrag.getActivity(), joinDTOList.get(position).getName(), joinDTOList.get(position).getUser_avtar(), R.style.DialogAnimations_SmileWindow);
