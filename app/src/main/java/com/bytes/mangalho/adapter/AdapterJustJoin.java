...
import com.bytes.mangalho.databinding.AdapterJustJoinBinding;
...
public class AdapterJustJoin extends RecyclerView.Adapter<AdapterJustJoin.MatchesHolder> {
    ...
    public MatchesHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        AdapterJustJoinBinding binding = DataBindingUtil.inflate(layoutInflater, R.layout.adapter_just_join, parent, false);
    ...
    public void onBindViewHolder(@NonNull final MatchesHolder holder, final int position) {
        ...
        if (joinDTOList.get(position).getShortlisted() == 0) {
            holder.binding.ivShortList.setImageDrawable(justJoinFrag.getResources().getDrawable(R.drawable.ic_shortlist));
        } else {
            holder.binding.ivShortList.setImageDrawable(justJoinFrag.getResources().getDrawable(R.drawable.ic_shortlist_done));
        }
        holder.binding.llShortList.setOnClickListener(new View.OnClickListener() {
            ...
            if (joinDTOList.get(position).getRequest() == 1) {
                holder.binding.ivInterest.setImageDrawable(justJoinFrag.getResources().getDrawable(R.drawable.ic_already_sent));
            } else if (joinDTOList.get(position).getRequest() == 2) {
                holder.binding.ivInterest.setImageDrawable(justJoinFrag.getResources().getDrawable(R.drawable.ic_send_interest));
            } else {
                holder.binding.ivInterest.setImageDrawable(justJoinFrag.getResources().getDrawable(R.drawable.ic_send_interest));
            }
        ...
        holder.binding.llContact.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (joinDTOList.get(position).getMobile2().equalsIgnoreCase("")) {
                    ...
                    spinnerDialog = new SpinnerDialog(justJoinFrag.getActivity(), joinDTOList.get(position).getName(), joinDTOList.get(position).getUser_avtar(), R.style.DialogAnimations_SmileWindow);
    ...
    public class MatchesHolder extends RecyclerView.ViewHolder {
        AdapterJustJoinBinding binding;

        public MatchesHolder(AdapterJustJoinBinding binding) {
