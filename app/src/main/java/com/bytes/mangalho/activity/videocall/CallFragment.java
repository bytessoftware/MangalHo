...
public class CallFragment extends Fragment {
  ...
  public ImageButton button_camera_on_off;
  ...
  public View onCreateView(
    ...
    button_camera_on_off = controlView.findViewById(R.id.button_camera_on_off);
    ...
    button_camera_on_off.setOnClickListener(new View.OnClickListener() {
      @Override
      public void onClick(View view) {
        boolean enabled = callEvents.onToggleVideo();
        if(enabled)
          button_camera_on_off.setBackgroundResource(R.drawable.cam_enable);
        else
          button_camera_on_off.setBackgroundResource(R.drawable.cam_disable);
      }
    });
  ...
  public void onStart() {
    ...
    if (args != null) {
      ...
      callType = args.getString(Consts.CALL_TYPE);
    ...
    if(callType.equals(Consts.CALL_TYPE_AUDIO))
    {
      callEvents.onVoiceCall();
      cameraSwitchButton.setVisibility(View.GONE);
      button_camera_on_off.setVisibility(View.GONE);
