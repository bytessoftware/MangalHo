...
package com.bytes.mangalho.activity.videocall;
...
import com.bytes.mangalho.activity.videocall.AppRTCAudioManager.AudioDevice;
import com.bytes.mangalho.activity.videocall.AppRTCAudioManager.AudioManagerEvents;
...
public class CallActivity extends Activity implements AppRTCClient.SignalingEvents,
  ...
  String receiver_name,receiver_image;
  ...
  public void onCreate(Bundle savedInstanceState) {
    ...
    String callType = intent.getStringExtra(Consts.CALL_TYPE);
    receiver_name = intent.getStringExtra(Consts.RECEIVER_NAME);
    receiver_image = intent.getStringExtra(Consts.RECEIVER_IMAGE);
    userName.setText(receiver_name);
    if(callType.equals(Consts.CALL_TYPE_VIDEO))
    {
      videoEnabled  = true;
    ...
    {
      videoEnabled  = false;
      loadImage(receiver_image);
    }
//    callFragment.button_camera_on_off.callOnClick();
  ...
  public void onVoiceCall() {
    if (peerConnectionClient != null) {
      peerConnectionClient.setOnlyAudioCall(false);
    }
  }
