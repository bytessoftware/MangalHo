...
import com.bytes.mangalho.activity.myprofile.DeleteImage;
import com.bytes.mangalho.adapter.GridImageshowAdapter;
...
import com.bytes.mangalho.view.ProfilePageProfilePhotoImageView;
                    ...
                    try {
                        ...
                        if (imageDatalist.size() > 0) {
                            ...
                            try {
                                ...
                                Glide.with(mContext).
                                        load(imageDatalist.get(0).getImage())
