...
public class SysApplicationold {
    private static Context mContext;
    private static SysApplicationold INSTANCE = null;

    // other instance variables can be here

    private SysApplicationold() {
    }

    public static synchronized SysApplicationold getInstance(Context context) {

        if (INSTANCE == null) {
            mContext = context;
            INSTANCE = new SysApplicationold();
    ...
    ArrayList<CommanDTO> ageList = new ArrayList<>();
    ...
    public ArrayList<CommanDTO> getMaritalList() {
        ...
        if (lookingForList.size() > 0) {
            ...
            lookingForList.add(new CommanDTO("2", mContext.getString(R.string.bride)));
            lookingForList.add(new CommanDTO("1", mContext.getString(R.string.groom)));
    ...
    } public ArrayList<CommanDTO> getAge() {
        if (ageList.size() > 0) {
            return ageList;
        } else {
            ageList.add(new CommanDTO("18", "18 "+mContext.getString(R.string.years)));
            ageList.add(new CommanDTO("19", "19 "+mContext.getString(R.string.years)));
            ageList.add(new CommanDTO("20", "20 "+mContext.getString(R.string.years)));
            ageList.add(new CommanDTO("21", "21 "+mContext.getString(R.string.years)));
            ageList.add(new CommanDTO("22", "22 "+mContext.getString(R.string.years)));
            ageList.add(new CommanDTO("23", "23 "+mContext.getString(R.string.years)));
            ageList.add(new CommanDTO("24", "24 "+mContext.getString(R.string.years)));
            ageList.add(new CommanDTO("25", "25 "+mContext.getString(R.string.years)));
            ageList.add(new CommanDTO("26", "26 "+mContext.getString(R.string.years)));
            ageList.add(new CommanDTO("27", "27 "+mContext.getString(R.string.years)));
            ageList.add(new CommanDTO("28", "28 "+mContext.getString(R.string.years)));
            ageList.add(new CommanDTO("29", "29 "+mContext.getString(R.string.years)));
            ageList.add(new CommanDTO("30", "30 "+mContext.getString(R.string.years)));
            ageList.add(new CommanDTO("31", "31 "+mContext.getString(R.string.years)));
            ageList.add(new CommanDTO("32", "32 "+mContext.getString(R.string.years)));
            ageList.add(new CommanDTO("33", "33 "+mContext.getString(R.string.years)));
            ageList.add(new CommanDTO("34", "34 "+mContext.getString(R.string.years)));
            ageList.add(new CommanDTO("35", "35 "+mContext.getString(R.string.years)));
            ageList.add(new CommanDTO("36", "36 "+mContext.getString(R.string.years)));
            ageList.add(new CommanDTO("37", "37 "+mContext.getString(R.string.years)));
            ageList.add(new CommanDTO("38", "38 "+mContext.getString(R.string.years)));
            ageList.add(new CommanDTO("39", "39 "+mContext.getString(R.string.years)));
            ageList.add(new CommanDTO("40", "40 "+mContext.getString(R.string.years)));
            ageList.add(new CommanDTO("41", "41 "+mContext.getString(R.string.years)));
            ageList.add(new CommanDTO("42", "42 "+mContext.getString(R.string.years)));
            ageList.add(new CommanDTO("43", "43 "+mContext.getString(R.string.years)));
            ageList.add(new CommanDTO("44", "44 "+mContext.getString(R.string.years)));
            ageList.add(new CommanDTO("45", "45 "+mContext.getString(R.string.years)));
            ageList.add(new CommanDTO("46", "46 "+mContext.getString(R.string.years)));
            ageList.add(new CommanDTO("47", "47 "+mContext.getString(R.string.years)));
            ageList.add(new CommanDTO("48", "48 "+mContext.getString(R.string.years)));
            ageList.add(new CommanDTO("49", "49 "+mContext.getString(R.string.years)));
            ageList.add(new CommanDTO("50", "50 "+mContext.getString(R.string.years)));
            ageList.add(new CommanDTO("51", "51 "+mContext.getString(R.string.years)));
            ageList.add(new CommanDTO("52", "52 "+mContext.getString(R.string.years)));
            ageList.add(new CommanDTO("53", "53 "+mContext.getString(R.string.years)));
            ageList.add(new CommanDTO("54", "54 "+mContext.getString(R.string.years)));
            ageList.add(new CommanDTO("55", "55 "+mContext.getString(R.string.years)));
            return ageList;
        }
    }
